...
function Bio() {
  return (
    <div className='title' >
        <img alt='' className='avatar' src='https://avatars.githubusercontent.com/u/98556712?s=400&u=70440eceb41ed018cce872033433fe6eeae38239&v=4' />
        <br/>
        <span className='span'>Joshua Keane Thompson</span>
        <br/>
        <br/>
